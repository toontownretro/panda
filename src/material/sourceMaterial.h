 ...
 */
class EXPCL_PANDA_MATERIAL SourceMaterial : public Material {
PUBLISHED:
...
public:
  ...
  static Material *create_SourceMaterial();
...
public:
  ...
  static void init_type() {
    Material::init_type();
    register_type(_type_handle, "SourceMaterial",
                  Material::get_class_type());
    MaterialRegistry::get_global_ptr()
      ->register_material(_type_handle, create_SourceMaterial);
  }
