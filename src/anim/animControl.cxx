 ...
 */
void AnimControl::
setup_anim(Character *part, AnimBundle *anim, int channel_index,
...
/**
 * Returns the Character bound in with this AnimControl.
 */
Character *AnimControl::
get_part() const {
  return _part;
}
