 ...
 * frame number.  last_frac and this_frac are the fractional steps into those
 * frames, which will be 0.0 unless we are running in frame_blend mode.
 */
