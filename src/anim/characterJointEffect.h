 ...
 */
class EXPCL_PANDA_ANIM CharacterJointEffect : public RenderEffect {
private:
  INLINE CharacterJointEffect();

PUBLISHED:
  static CPT(RenderEffect) make(CharacterNode *character);

  INLINE PT(CharacterNode) get_character() const;

public:
  INLINE bool matches_character(CharacterNode *character) const;
