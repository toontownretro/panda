...
/* BUILDING_PANDA is just a buildsystem shortcut for all of these: */
  ...
  #define BUILDING_PANDA_JOBSYSTEM
  #define BUILDING_PANDA_KEYVALUES
  #define BUILDING_PANDA_LINMATH
  #define BUILDING_PANDA_MAP
  #define BUILDING_PANDA_MAPBUILDER
  #define BUILDING_PANDA_MATERIAL
  ...
  #define BUILDING_PANDA_PARTICLESYSTEM2
  #define BUILDING_PANDA_PDX
...
/* BUILDING_PANDAEXPRESS for these: */
  ...
  #define BUILDING_PANDAEXPRESS_STUB
...
/* BUILDING_PANDAPHYSICS for these: */
  ...
  #define BUILDING_PANDAPHYSICS_STUB
  #define BUILDING_PANDA_PARTICLESYSTEM
  #define BUILDING_PANDA_PHYSICS
#endif

/* BUILDING_PANDAGLES for these: */
#ifdef BUILDING_PANDAGLES
  #define BUILDING_PANDAGLES_STUB
  #define BUILDING_PANDA_GLESGSG
#endif

/* BUILDING_PANDAGLES2 for these: */
#ifdef BUILDING_PANDAGLES2
  #define BUILDING_PANDAGLES2_STUB
  #define BUILDING_PANDA_GLES2GSG
#endif

/* BUILDING_PANDADX for these: */
#ifdef BUILDING_PANDADX
  #define BUILDING_PANDADX_STUB
  #define BUILDING_PANDA_DXGSG9
#endif

/* BUILDING_PANDADX11 for these: */
#ifdef BUILDING_PANDADX11
  #define BUILDING_PANDADX11_STUB
  #define BUILDING_PANDA_DXGSG11
#endif

#ifdef BUILDING_PANDA_STUB
  #define EXPCL_PANDA_STUB EXPORT_CLASS
  #define EXPTP_PANDA_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDA_STUB IMPORT_CLASS
  #define EXPTP_PANDA_STUB IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDAEGG_STUB
  #define EXPCL_PANDAEGG_STUB EXPORT_CLASS
  #define EXPTP_PANDAEGG_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAEGG_STUB IMPORT_CLASS
  #define EXPTP_PANDAEGG_STUB IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDAEXPRESS_STUB
  #define EXPCL_PANDAEXPRESS_STUB EXPORT_CLASS
  #define EXPTP_PANDAEXPRESS_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAEXPRESS_STUB IMPORT_CLASS
  #define EXPTP_PANDAEXPRESS_STUB IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDAPHYSICS_STUB
  #define EXPCL_PANDAPHYSICS_STUB EXPORT_CLASS
  #define EXPTP_PANDAPHYSICS_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAPHYSICS_STUB IMPORT_CLASS
  #define EXPTP_PANDAPHYSICS_STUB IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_BSP
  #define EXPCL_PANDA_BSP EXPORT_CLASS
  #define EXPTP_PANDA_BSP EXPORT_TEMPL
#else
  #define EXPCL_PANDA_BSP IMPORT_CLASS
  #define EXPTP_PANDA_BSP IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDAGL_STUB
  #define EXPCL_PANDAGL_STUB EXPORT_CLASS
  #define EXPTP_PANDAGL_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAGL_STUB IMPORT_CLASS
  #define EXPTP_PANDAGL_STUB IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_JOBSYSTEM
  #define EXPCL_PANDA_JOBSYSTEM EXPORT_CLASS
  #define EXPTP_PANDA_JOBSYSTEM EXPORT_TEMPL
#else
  #define EXPCL_PANDA_JOBSYSTEM IMPORT_CLASS
  #define EXPTP_PANDA_JOBSYSTEM IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_KEYVALUES
  #define EXPCL_PANDA_KEYVALUES EXPORT_CLASS
  #define EXPTP_PANDA_KEYVALUES EXPORT_TEMPL
#else
  #define EXPCL_PANDA_KEYVALUES IMPORT_CLASS
  #define EXPTP_PANDA_KEYVALUES IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_MAP
  #define EXPCL_PANDA_MAP EXPORT_CLASS
  #define EXPTP_PANDA_MAP EXPORT_TEMPL
#else
  #define EXPCL_PANDA_MAP IMPORT_CLASS
  #define EXPTP_PANDA_MAP IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_MAPBUILDER
  #define EXPCL_PANDA_MAPBUILDER EXPORT_CLASS
  #define EXPTP_PANDA_MAPBUILDER EXPORT_TEMPL
#else
  #define EXPCL_PANDA_MAPBUILDER IMPORT_CLASS
  #define EXPTP_PANDA_MAPBUILDER IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_MATERIAL
  #define EXPCL_PANDA_MATERIAL EXPORT_CLASS
  #define EXPTP_PANDA_MATERIAL EXPORT_TEMPL
#else
  #define EXPCL_PANDA_MATERIAL IMPORT_CLASS
  #define EXPTP_PANDA_MATERIAL IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_PARTICLESYSTEM2
  #define EXPCL_PANDA_PARTICLESYSTEM2 EXPORT_CLASS
  #define EXPTP_PANDA_PARTICLESYSTEM2 EXPORT_TEMPL
#else
  #define EXPCL_PANDA_PARTICLESYSTEM2 IMPORT_CLASS
  #define EXPTP_PANDA_PARTICLESYSTEM2 IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_PDX
  #define EXPCL_PANDA_PDX EXPORT_CLASS
  #define EXPTP_PANDA_PDX EXPORT_TEMPL
#else
  #define EXPCL_PANDA_PDX IMPORT_CLASS
  #define EXPTP_PANDA_PDX IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_PPHYSICS
  #define EXPCL_PANDA_PPHYSICS EXPORT_CLASS
  #define EXPTP_PANDA_PPHYSICS EXPORT_TEMPL
#else
  #define EXPCL_PANDA_PPHYSICS IMPORT_CLASS
  #define EXPTP_PANDA_PPHYSICS IMPORT_TEMPL
#endif
  ...
  #define EXPTP_PANDA_RAYTRACE IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_DXGSG9
  #define EXPCL_PANDA_DXGSG9 EXPORT_CLASS
  #define EXPTP_PANDA_DXGSG9 EXPORT_TEMPL
#else
  #define EXPCL_PANDA_DXGSG9 IMPORT_CLASS
  #define EXPTP_PANDA_DXGSG9 IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_DXGSG11
  #define EXPCL_PANDA_DXGSG11 EXPORT_CLASS
  #define EXPTP_PANDA_DXGSG11 EXPORT_TEMPL
#else
  #define EXPCL_PANDA_DXGSG11 IMPORT_CLASS
  #define EXPTP_PANDA_DXGSG11 IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDADX_STUB
  #define EXPCL_PANDADX_STUB EXPORT_CLASS
  #define EXPTP_PANDADX_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDADX_STUB IMPORT_CLASS
  #define EXPTP_PANDADX_STUB IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDADX11_STUB
  #define EXPCL_PANDADX11_STUB EXPORT_CLASS
  #define EXPTP_PANDADX11_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDADX11_STUB IMPORT_CLASS
  #define EXPTP_PANDADX11_STUB IMPORT_TEMPL
#endif
...
#ifdef BUILDING_PANDA_GLESGSG
  #define EXPCL_PANDA_GLESGSG EXPORT_CLASS
  #define EXPTP_PANDA_GLESGSG EXPORT_TEMPL
#else
  #define EXPCL_PANDA_GLESGSG IMPORT_CLASS
  #define EXPTP_PANDA_GLESGSG IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDAGLES_STUB
  #define EXPCL_PANDAGLES_STUB EXPORT_CLASS
  #define EXPTP_PANDAGLES_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAGLES_STUB IMPORT_CLASS
  #define EXPTP_PANDAGLES_STUB IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDA_GLES2GSG
  #define EXPCL_PANDA_GLES2GSG EXPORT_CLASS
  #define EXPTP_PANDA_GLES2GSG EXPORT_TEMPL
#else
  #define EXPCL_PANDA_GLES2GSG IMPORT_CLASS
  #define EXPTP_PANDA_GLES2GSG IMPORT_TEMPL
#endif

#ifdef BUILDING_PANDAGLES2_STUB
  #define EXPCL_PANDAGLES2_STUB EXPORT_CLASS
  #define EXPTP_PANDAGLES2_STUB EXPORT_TEMPL
#else
  #define EXPCL_PANDAGLES2_STUB IMPORT_CLASS
  #define EXPTP_PANDAGLES2_STUB IMPORT_TEMPL
#endif
