...
/**
 * Replaces the material at the indicated index with the indicated material.
 */
void MaterialCollection::
set_material(int index, Material *node_material) {
  nassertv(index >= 0 && index < _materials.size());
  _materials[index] = node_material;
}
