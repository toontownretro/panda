...
cull_callback(CullTraverser *trav, CullTraverserData &data) {
  ...
  CullableObject *occluder_viz = new CullableObject(get_occluder_viz(trav, data), get_occluder_viz_state(trav, data),
  ...
  CullableObject *frame_viz = new CullableObject(_frame_viz, get_frame_viz_state(trav, data),
                       data.get_internal_transform(trav), current_thread);
