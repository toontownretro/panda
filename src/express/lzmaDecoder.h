...
class EXPCL_PANDA_EXPRESS CLZMA
{
public:
  unsigned int	Uncompress( unsigned char *pInput, unsigned char *pOutput, LZMAReadProgressCallbackFunc_t pCallback = NULL );

  unsigned int	Uncompress( unsigned char *pInput, unsigned char *pOutput, int actualSize, int lzmaSize, char properties[5], LZMAReadProgressCallbackFunc_t pCallback = NULL );
