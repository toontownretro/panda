...
CLP(GraphicsStateGuardian)(GraphicsEngine *engine, GraphicsPipe *pipe) :
  ...
  _active_ppbuffer_memory_pcollector("Graphics memory:" + _prepared_objects->get_name() + ":Active:ppbuffer"),
  _inactive_ppbuffer_memory_pcollector("Graphics memory:" + _prepared_objects->get_name() + ":Inactive:ppbuffer")
{
  _error_count = 0;
