...
#define _EPI32_CONST(Name, Val) \
        static const int32_t _epi32_##Name[4] __attribute__((aligned(16))) = {Val, Val, Val, Val}
...
#elif __GNUC__
        __asm__ __volatile__("rsqrtss %0, %1"
                             : "=x"(rroot)
                             : "x"(x));
#else
#error
...
#ifdef __GNUC__
// #define _PS_CONST(Name, Val) static const ALIGN_16BYTE float _ps_##Name[4] = { Val, Val, Val, Val }
#define _PS_CONST_TYPE(Name, Type, Val) static const ALIGN_16BYTE Type _ps_##Name[4] = {Val, Val, Val, Val}

_PS_CONST_TYPE(sign_mask, int, 0x80000000);
_PS_CONST_TYPE(inv_sign_mask, int, ~0x80000000);

#define _PI32_CONST(Name, Val) static const ALIGN_16BYTE int _pi32_##Name[4] = {Val, Val, Val, Val}
